...
class Events extends Admin_Controller
{
    ...
    public function create()
    {
        ...
        $this->form_validation->set_rules('start_date', $this->lang->line('start') . " " . $this->lang->line('date'), 'trim|required|xss_clean');
        $this->form_validation->set_rules('end_date', $this->lang->line('event') . " " . $this->lang->line('date'), 'trim|required|xss_clean');
    ...
    public function enableFeatured()
    {
        ...
        if ($id == "" && !isset($id)) {
            ...
            echo json_encode(array('status' => 0, 'msg' => 'Recored updated successfully'));
            exit;
        }
        echo json_encode(array('status' => 1, 'msg' => 'something wrong'));
    }
    ...
    public function edit($slug)
    {
        ...
        $this->form_validation->set_rules('end_date', 'Event Date', 'trim|required|xss_clean');
