...
class Conferencehistory_model extends CI_Model
{
    ...
    {
        $this->db->select('conferences_history.*,patients.id as pid,patients.patient_name,patients.patient_unique_id,patients.mobileno')->from('conferences_history');
        $this->db->where('conference_id', $conference_id);
