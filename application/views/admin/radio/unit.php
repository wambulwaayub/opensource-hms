                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                if ($this->rbac->hasPrivilege('radiology_unit', 'can_delete')) {
                                                    ?>
                                                    <a class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="delete_recordById('<?php echo base_url(); ?>admin/lab/deleteunit/<?php echo $lab['id'] ?>', '<?php echo $this->lang->line('delete_message'); ?>')";>
