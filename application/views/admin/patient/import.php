            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">      
                        ...
                        <br/>           
                        1. <?php echo $this->lang->line('your_csv_data_should_be_in_the_format_below'); ?><br/>
                        2. <?php echo $this->lang->line('for_patient_gender'); ?><br/>
                        3. <?php echo $this->lang->line('for_patient_blood_group'); ?><br/>
                        4. <?php echo $this->lang->line('for_age_column'); ?><br/>
                        5. <?php echo $this->lang->line('for_patient_marital_status'); ?><br/>
                        <hr/>
