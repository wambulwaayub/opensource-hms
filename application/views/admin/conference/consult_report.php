            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"></i><?php echo $this->lang->line('live_consult') . ' ' . $this->lang->line('report'); ?></h3>
                    </div>
                    <div class="box-body">
                        ...
                        <div class="download_label"><?php echo $this->lang->line("live_consult") . " " . $this->lang->line('report') ?></div>
...
if (empty($consultList)) {
    ...
    foreach ($consultList as $meeting_key => $meeting_value) {
...
if ($meeting_value->description == "") {
        ...
        ?>
                                                ...
                                                <td class="mailbox-name">
                                                    <?php echo date($this->customlib->getSchoolDateFormat(true, true), strtotime($meeting_value->date)) ?>
                                                </td>
                                                <td class="mailbox-name">
