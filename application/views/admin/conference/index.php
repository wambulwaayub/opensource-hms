            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"></i> <?php echo $this->lang->line('setting') ?></h3>
                    </div>
                    <form id="form1" action="<?php echo base_url() ?>admin/conference"   name="employeeform" class="form-horizontal form-label-left" method="post" accept-charset="utf-8">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="exampleInputEmail1">
                               <?php echo $this->lang->line('doctor_api_credential'); ?><small class="req"> *</small>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
...
?>><?php echo $this->lang->line('enabled'); ?>
                            ...
                            <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="exampleInputEmail1">
                                        <?php echo $this->lang->line('default_opd_duration') . " (" . $this->lang->line('in_minutes') . ")"; ?><small class="req"> </small>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                             ...
                             <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="exampleInputEmail1">
                                        <?php echo $this->lang->line('default_ipd_duration') . " (" . $this->lang->line('in_minutes') . ")"; ?><small class="req"> </small>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
