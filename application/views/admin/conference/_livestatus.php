...
<div class="row">
    ...
    <div class="col-lg-4 col-md-4">
        <label>
            <span class="labalblock"> <?php echo $this->lang->line('date'); ?></span> <span class="text-dark robo-normal"><?php echo date($this->customlib->getSchoolDateFormat(true, true), strtotime($live->date)); ?></span>
        </label>
    </div>
    <div class="col-lg-4 col-md-4">
        <label>
            <span class="labalblock"> <?php echo $this->lang->line('duration') . " (" . $this->lang->line('in_minutes') . ")"; ?></span> <span class="text-dark robo-normal"><?php echo $live->duration; ?></span>
        </label>
    </div>
</div>
...
if ($api_Response->status == "waiting") {
    ...
    if ($conference_setting->use_zoom_app) {
        ...
        if ($live->purpose == "consult") {
            $url = site_url('admin/conference/join/consult' . '/' . $live->id);
        } elseif ($live->purpose == "meeting") {
