...
echo $this->lang->line('finished');
        ...
        ?>
                                                ...
                                                <td class="mailbox-date text-right relative" width="100">
                                                    <?php
if ($conference_value->status == 0) {
            if ($conference_value->created_id == $logged_staff_id) {
            ...
            ?>
     <a data-placement="left" href="#" class="btn btn-sm label-success start-mr-20 p0" data-toggle="modal" data-target="#modal-chkstatus" data-id="<?php echo $conference_value->id; ?>">
