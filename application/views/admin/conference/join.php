        ...
        <nav id="nav-tool" class="navbar navbar-inverse navbar-fixed-top">
            <div class="container">
                <div class="navbar-header">
                    <h4><i class="fab fa-chromecast"></i> <?php echo $this->lang->line('live_consult').' '.$this->lang->line('title'); ?>: <?php echo $title; ?></h4>
                </div>
                <div class="navbar-form navbar-right">
                    <h5><i class="far fa-user-circle" style=""></i> <?php echo $this->lang->line('host').' '.$this->lang->line('by'); ?>: <?php echo $host; ?></h5>
                </div>
            </div>
        </nav>
