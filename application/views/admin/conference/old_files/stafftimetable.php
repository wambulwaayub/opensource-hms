                                    ...
                                    if (empty($conferences)) {
                                        ...
                                        foreach ($conferences as $conference_key => $conference_value) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-name">
                                                    <?php
                                                    echo $conference_value->create_for_name . " " . $conference_value->create_for_surname;
                                                    ?>
                                                </td>
...
<input type="hidden" class="form-control" id="password" name="password">
                    <div class="row">
                        ...
                        <div class="clearfix"></div>
                        <div class="form-group col-xs-10 col-sm-12 col-md-12 col-lg-12">
                            <label for="class">Role --r<small class="req"> *</small></label>
                        ...
                        <div class="clearfix"></div>
                        <div class="form-group col-xs-10 col-sm-12 col-md-12 col-lg-12">
                            <label for="class">Staff --r<small class="req"> *</small></label>
