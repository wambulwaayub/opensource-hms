...
if ($this->rbac->hasPrivilege('death_record', 'can_add')) {
    ?>
                                <a data-toggle="modal" onclick="holdModal('myModal')" class="btn btn-primary btn-sm deathrecord"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add') . " " . $this->lang->line('death_record'); ?></a>
                            <?php }?>
                        </div>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <select onchange="get_PatientDetails(this.value)" id="selectdata"  style="width: 100%" class="form-control select2"<?php
...
<script type="text/javascript">
    ...
    $('.test_ajax').DataTable({
        ...
        "ajax": {
            "url": base_url+"admin/searchdatatable/death_record",
            "type": "POST"
        },
        responsive: 'true',
            dom: "Bfrtip",
...
$(".deathrecord").click(function(){
    $('#formadd').trigger("reset");
    $('#select2-selectdata-container').html("");
    get_PatientDetails();
});
</script>