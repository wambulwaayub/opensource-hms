...
if ($this->rbac->hasPrivilege('gallery', 'can_edit')) {
        ...
        if ($this->rbac->hasPrivilege('gallery', 'can_delete')) {
            ?>
                                                            <a  class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="delete_recordById('<?php echo site_url('admin/front/gallery/delete/' . $page['slug']); ?>', '<?php echo $this->lang->line('delete_message'); ?>')">
