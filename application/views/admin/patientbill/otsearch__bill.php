...
<?php } ?>
                            ...
                            <div class="col-sm-6">
                               <div class="form-group">
                                   ...
                                   <input type="text" name="discount_amount" onchange="multiply(0)" id="discount_amount0" placeholder="Discount Amount" class="form-control text-right">
                                    <input type="text" name="discount_percent" onchange="multiply(0)" disabled id="discount_percent0" placeholder="%" class="form-control text-right">
                                </div>
                            ...
                            <div class="col-sm-6">
                               <div class="form-group">
                                   ...
                                   <input type="text" name="tax_amount" onchange="multiply(0)" id="tax_amount0" placeholder="Tax Amount" class="form-control text-right">
                                    <input type="text" name="tax_percent" onchange="multiply(0)" disabled id="tax_percent0" placeholder="%" class="form-control text-right">
                                </div>
                ...
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table class="table tableover table-striped table-bordered table-hover" id="tableID">
                                        <tr>
...
$(".modalbtnpatient").click(function(){	
	...
	function refreshmodal(){
		...
		for (i = 1; i < table_len; i++) {			
            ...
            //     var amount = $('#apply_charge' + id).val();
            //     var discount_text = $('#discount_amount' + id).val();
            //     var tax_text = $('#tax_amount' + id).val();
            //     //var total_amount = amount.toFixed(2) ;
            //     if (discount_text !='' ) {
            //         var discount = (discount_text / amount) * 100;
            //         $("#discount_percent" + id ).val(discount.toFixed(2));
            //     }else{
                      
            //         var discount = 0 ;
            //         var discount_text = $('#discount_amount' + id).val(discount);
            //         $("#discount_percent" + id ).val(discount.toFixed(2));
            //     }
              
            //     if(tax_text != ''){
            //         var tax = (tax_text / (amount - discount_text)) * 100;
            //         $("#tax_percent" + id).val(tax.toFixed(2));
                   
            //     }else{
            //         var tax = 0
            //         var tax_text = $("#tax_amount" + id).val(tax);
            //        $("#tax_percent" + id).val(tax.toFixed(2));
            //     } 

               
            //     var net_amount = parseFloat(amount) + parseFloat(tax_text) - parseFloat(discount_text);
            //     //var total_amount = net_amount.toFixed(2) ;
              
            //     $('#total_amount' + id).val(net_amount.toFixed(2)); 
