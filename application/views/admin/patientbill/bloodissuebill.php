            ...
            <div class="col-md-2">
                <div class="box border0">
                    <ul class="tablists">
                        ...
                        <li>
                            <a href="<?php echo base_url(); ?>admin/patientbill/searchbloodissue" class="active"><?php echo $this->lang->line('blood_bank') ; ?></a>
                        </li>
                         <li>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="bloodissue_id" id="bloodissueidpay" class="form-control">
        ...
        function multiply(id) {
            ...
            $('#balance_amount' + id).val(balance_amount);
             ...
             function addpaymentModal(id) {
                 $.ajax({
                    url: '<?php echo base_url(); ?>admin/bloodbank/getbloodissueDetail',
                    type: "POST",
                    data: {id: id},
                    dataType: 'json',
                    success: function (data) {
                        $("#bloodissueidpay").val(data.id);
                       // console.log(data);
                        ...
                        $("#patient_idpay").val(data.recieve_to);
            ...
            $("#add_payment").on('submit', (function (e) {
               // alert("Hello")
                ...
                $.ajax({
                    url: '<?php echo base_url(); ?>admin/payment/addbloodissuePayment',
                    type: "POST",
                    data: new FormData(this),
                    dataType: 'json',
                    contentType: false,
