            ...
            <div class="col-md-10">              
                <div class="box box-primary" id="tachelist">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('specialist'); ?> <?php echo $this->lang->line('list'); ?></h3>
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('specialist', 'can_add')) { ?>
                                <a data-toggle="modal" data-target="#myModal" class="btn btn-primary btn-sm specialist"><i class="fa fa-plus"></i>  <?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('specialist'); ?></a>    
                            <?php } ?> 
                        </div>
                    </div>
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages">
                            <div class="download_label"><?php echo $this->lang->line('specialist'); ?></div>
    ...
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                ...
                <h4 class="box-title"> <?php echo $this->lang->line('add'); ?>  <?php echo $this->lang->line('specialist'); ?></h4> 
            </div>
...
<script>
    $(document).ready(function () {
        ...
        var table = $("#dt_table").dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "<?php echo site_url('admin/specialist/get') ?>", "type": "POST"},
            columns: [
    ...
    {
        delete_recordById('<?php echo base_url() ?>admin/specialist/specialistdelete/' + id, '<?php echo $this->lang->line('delete_message') ?>');
    }
