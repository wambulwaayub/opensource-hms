            ...
            <div class="col-md-2">
                <div class="box border0">
                    ...
                    <?php } if ($this->rbac->hasPrivilege('pathology_unit', 'can_view')) { ?>
                        ...
                        <li><a class="active" href="<?php echo base_url(); ?>admin/pathologycategory/pathoparameter" class=""><?php echo $this->lang->line('pathology') . " " . $this->lang->line('parameter'); ?></a></li>
                         <?php }  ?>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-md-10">              
                <div class="box box-primary" id="tachelist">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('pathology') . " " . $this->lang->line('parameter') . " " . $this->lang->line('list'); ?></h3>
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('pathology_parameter', 'can_add')) { ?>
                                <a data-toggle="modal" data-target="#myModal" class="btn btn-primary btn-sm pathology"><i class="fa fa-plus"></i>  <?php echo $this->lang->line('add') . " " . $this->lang->line('pathology') . " " . $this->lang->line('parameter'); ?></a> 
                            <?php } ?>    
                        </div>
                    </div>
                    <div class="box-body">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                if ($this->rbac->hasPrivilege('pathology_parameter', 'can_delete')) {
                                                    ?>
                                                    <a class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="delete_recordById('<?php echo base_url(); ?>admin/pathologycategory/deleteparameter/<?php echo $lab['id'] ?>', '<?php echo $this->lang->line('delete_message'); ?>')";>
    ...
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                ...
                <h4 class="box-title"> <?php echo $this->lang->line('add') . " " . $this->lang->line('pathology') . " " . $this->lang->line('parameter'); ?></h4> 
            </div>
            <form id="formadd" action="<?php echo site_url('admin/pathologycategory/addparameter') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
                        ...
                        <!-- <div class="form-group">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line('test') . " " . $this->lang->line('value'); ?></label><small class="req"> *</small>
                            <input autofocus="" name="test_value" placeholder="" type="text" class="form-control"  />
                            <span class="text-danger"><?php echo form_error('test_value'); ?></span>
                        </div>  -->
                       ...
                       <!--  <div class="form-group">
                            ...
                            <input autofocus="" name="unit" placeholder="" type="text" class="form-control"  />
            ...
            <form id="editformadd" action="<?php echo site_url('admin/pathologycategory/addparameter') ?>" name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
                        ...
                        <!--  <div class="form-group">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line('test') . " " . $this->lang->line('value'); ?></label><small class="req"> *</small>
                            <input autofocus="" id="test_value" name="test_value" placeholder="" type="text" class="form-control"  value="" />
                            <span class="text-danger"><?php echo form_error('test_value'); ?></span>
