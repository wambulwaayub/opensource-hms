                    ...
                    <div class="box-header with-border">
                        ...
                        <?php if (empty($printing_list)) {
                            ...
                            <div class="box-tools pull-right">
                                <?php if ($this->rbac->hasPrivilege('print_payslip_header_footer', 'can_add')) { ?>
                                        ...
                                        foreach ($printing_list as $key => $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right">
                                                    <?php if ($this->rbac->hasPrivilege('print_payslip_header_footer', 'can_edit')) { ?>
                                                    ...
                                                    <?php } ?>
                                                    <?php if ($this->rbac->hasPrivilege('print_payslip_header_footer', 'can_delete')) { ?>
