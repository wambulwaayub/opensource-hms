...
if ($this->rbac->hasPrivilege('birth_death_customfields', 'can_add')) {
    ?>
                                <a data-toggle="modal" onclick="holdModal('myModal')" class="btn btn-primary btn-sm death_record"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add'); ?></a>
                            <?php }?>
                        </div>
                    </div><!-- /.box-header -->
                    <div class="box-body">
