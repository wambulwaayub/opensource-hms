            ...
            ?>
                                            <tr class="<?php echo $class; ?>">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?php echo base_url(); ?>patient/dashboard/ipdprofile/<?php echo $patient['ipdid']; ?>"><?php echo $patient['patient_name']; ?></a>
                                                </td>
                                                ...
                                                <!-- <td class="text-right"><?php echo $patient['charges'] - $patient['payment'] + $patient['othercharge'] ?></td> -->
                                            </tr>
                                            <?php
$count++;
        }
