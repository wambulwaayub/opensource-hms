...
if (!empty($result['month'])) {
    echo $result["month"] . " Month";
                         ...
                         <tr>
                            ...
                            <td width="25%"><?php echo date($this->customlib->getSchoolDateFormat(true, true), strtotime($result['appointment_date'])); ?></td>
                            <th><?php echo $this->lang->line('discharged') . " " . $this->lang->line('date'); ?></th>
                            <td width="30%" align="left"><?php echo date($this->customlib->getSchoolDateFormat(true, false), strtotime($result['discharge_date'])); ?></td>
                        </tr>
                        <tr>
