...
foreach ($detail as $bill) {
    ?>
                            ...
                            <td> <?php if (!empty($bill["pathology_report"])) {?>
                                    <a <?php if ($print != 'yes') {?>href="<?php echo base_url(); ?>patient/dashboard/download/<?php echo $bill["pathology_report"]; ?>"<?php }?> class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('download'); ?>"> <i class="fa fa-download"></i>
...
foreach ($parameterdetails as $value) {
    ...
    ?>
                                            <tr id="row0">
                                                ...
                                                <td align="left"><?php echo $value["pathology_report_value"]; ?></td>
...
<script type="text/javascript">
    function printData(id,pathology_id) {
        ...
        $.ajax({
            url: base_url + 'patient/dashboard/getReportDetailsPatho/' + id +'/' + pathology_id,
            type: 'POST',
