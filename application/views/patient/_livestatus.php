...
<div class="row">
  <div class="col-lg-12 col-md-12">
    ...
    <div class="col-lg-4 col-md-4">
        <label>
            <span class="labalblock"> <?php echo $this->lang->line('date'); ?></span> <span class="text-dark robo-normal"><span class="text-dark"><?php echo date($this->customlib->getSchoolDateFormat(true, true), strtotime($live->date)); ?></span>
        </label>
    </div>
...
if ($api_Response->status == "started") {
  ...
  <?php
        ...
        ?>
      <a data-placement="left" href="<?php echo site_url('patient/dashboard/join/' . $live->id); ?>" class="btn btn-outline-success btn-sm pull-right">
            <i class="fa fa-video-camera"></i> <?php echo $this->lang->line('join') . ' ' . $this->lang->line('now'); ?>
      </a>
