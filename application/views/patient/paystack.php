                        ...
                        <table class="table table-striped mb0 font13">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" calass="form-control"  name="email" value="<?php echo set_value('email', $patient['email']); ?>">
                                    </td>
                                </tr>
                                <tr>
...
?></td>
                        ...
                        <input type="hidden" name="payment_type" value="<?php echo $payment_type ?>">
                         <input type="submit" id="formaddbtn" class="btn btn-primary col-md-offset-3 pull-right" value="Pay by Paystack" />
                       </form>
                    </div><!-- /.box-body -->
...
<script>
      $(document).ready(function (e) {
        $("#formadd").on('submit', (function (e) {
            ...
            e.preventDefault();
            $.ajax({
                url: '<?php echo base_url(); ?>patient/paystack/pay_bypaystack',
                type: "POST",
