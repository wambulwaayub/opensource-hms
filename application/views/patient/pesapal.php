        ...
        <div class="row"> 
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                         <form method="post" action="<?php echo base_url(); ?>patient/pesapal">
...
?></td>
                       ...
                       <input id="formaddbtn"  class="btn btn-primary col-md-offset-3 pull-right" type="submit"  value="Pay by Pesapal" >
