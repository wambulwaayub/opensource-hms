...
?>">
                ...
                <div class='input-group' >
                    <input type='text' class="form-control" id='datetimepicker'  name="date" value="<?php echo set_value('date') ?>"  /><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                </div>
            </div>
        </div><!--./col-md-6-->
        <div class="col-md-6">
...
?>">
                ...
                <select name="specialist" onchange="getdoctor(this.value)" class="form-control select2">
                    ...
                    <?php
foreach ($specialist as $specialist_key => $specialist_value) {
    ?>
